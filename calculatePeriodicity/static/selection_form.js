...
function loadAnchorsData(callback) {
    $.getJSON("static/anchors.json", function (data) {
        callback(data);
    });
}
...
function ProbeGrouping(countries, asn2holder, probeCity) {
    ...
    var rootIcon = function (_) { return "static/images2/world1.png" };
    var continentIcon = function (continent) { return "static/images2/continent3.jpg" };
    var countryIcon = function (countryCode) { return "static/flag_icons/" + countryCode.toLowerCase() + ".png" };
    var cityIcon = function (city) { return "static/images2/city3.png" };
    var anchorIcon = function (anchor) { return "static/images2/device.png" };
    var probeIcon = function (anchor) { return "static/images2/device.png" };
...
function onLaunchtplayButtonClick() {
    document.location = "http://localhost:8000/calculate-periodicity/" +
